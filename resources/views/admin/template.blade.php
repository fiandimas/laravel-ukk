        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="{{ isset($alevel) ? $alevel : '' }}">
                        <a href="{{ route('admin.level') }}">
                            <i class="material-icons">home</i>
                            <span>Data Level</span>
                        </a>
                    </li>
                    <li class="{{ isset($aadmin) ? $aadmin : '' }}">
                        <a href="{{ route('admin.admin') }}">
                            <i class="material-icons">home</i>
                            <span>Data Admin</span>
                        </a>
                    </li>
                    <li class="{{ isset($acost) ? $acost : '' }}">
                        <a href="{{ route('cost') }}">
                            <i class="material-icons">home</i>
                            <span>Data Tarif</span>
                        </a>
                    </li>
                    <li class="{{ isset($acustomer) ? $acustomer : '' }}">
                        <a href="{{ route('customer') }}">
                            <i class="material-icons">home</i>
                            <span>Data Pengguna</span>
                        </a>
                    </li>
                    <li class="{{ isset($ausage) ? $ausage : '' }}">
                        <a href="{{ route('usage') }}">
                            <i class="material-icons">home</i>
                            <span>Data Penggunaan</span>
                        </a>
                    </li>
                    <li class="{{ isset($apayment) ? $apayment : '' }}">
                    ...
                    @endif
                    <li class="{{ isset($ahistory) ? $ahistory : '' }}">
